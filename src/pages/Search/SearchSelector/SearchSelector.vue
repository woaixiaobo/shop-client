<template>
  <div class="clearfix selector">
    ...
    <div class="type-wrap" v-for="arr in attrsList" :key="arr.attrId">
...
import {mapState} from "vuex"
  export default {
    name: 'SearchSelector',
    props:{
      setTrademark:Function,//跟新父组件的options当中的trademark数据
      addProp:Function,//更新(添加)父组件options当中的props数组的数据
    },
    computed: {
      ...mapState({
        trademarkList:state=>state.search.productList.trademarkList, //品牌列表数据
        attrsList: state => state.search.productList.attrsList, // 属性列表
      })
    },
  }
</script>
